...
\begin{proof}
  ...
  algorithm~\cite{schoof95}. We also need to compute the $\ell$th
  modular polynomial $\Phi_\ell\bmod p$; for this, we compute is over
  $\Z$ then reduce it modulo $p$. The cost is negligible compared to
  that of the point countings~\cite{enge09}.
