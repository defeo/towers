  ...
  \begin{columns}
    \begin{column}{0.6\textwidth}
      \begin{center}
        \begin{tikzpicture}
          \draw (-60:-1) circle (2);
          \path (-60:-1) -- +(-1.4,0.4) node {\Large\alert{$\F_q$}};
          \draw (0:0) node {$1$};
          \pause
          %%%%%%%%%% 
          \foreach \i in {1,...,4} {
          ...
          \path (-60:-1) -- +(-2.1,1.4) node (Fl) {\Large\alert{$\F_{q^\ell}$}};
          \foreach\k in {0,...,4} {
          ...
          \pause
          %%%%%%%%%% 
          \path (-60:-1) -- +(-3.6,2.8) node (Fbar) {\Large\alert{$\bar{\F}_q$}};
    ...
    \begin{column}{0.4\textwidth}
      \begin{itemize}
      \item<1-> $\ell|(q-1)$;
      \item<3-> $\phi$ not surjective over $\F_q$;
      \item<5-> $\phi : \mathbb{G}_m \to \mathbb{G}_m$ surjective.
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
